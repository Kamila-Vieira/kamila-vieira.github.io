...
/***/ "./src/scripts/components/repositories/index.mjs":
/*!*******************************************************!*\
  !*** ./src/scripts/components/repositories/index.mjs ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Repositories": () => (/* binding */ Repositories)
/* harmony export */ });
/* harmony import */ var _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../services/api/index.mjs */ "./src/scripts/services/api/index.mjs");
...
var Repositories = {
  ...
  getUserRepositories: function () {
    var _getUserRepositories = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_0__.Api.getReposList();
    ...
    function getUserRepositories() {
      return _getUserRepositories.apply(this, arguments);
    }

    return getUserRepositories;
  }(),
  getUserRepository: function () {
    var _getUserRepository = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(repoName) {
      var data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_0__.Api.getRepoData(repoName);
    ...
    function getUserRepository(_x) {
      return _getUserRepository.apply(this, arguments);
    }
...
/***/ "./src/scripts/components/user/index.mjs":
/*!***********************************************!*\
  !*** ./src/scripts/components/user/index.mjs ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var User = {
  ...
  updateInitialUserData: function () {
    var _updateInitialUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_0__.Api.getUserData();
    ...
    function updateInitialUserData() {
      return _updateInitialUserData.apply(this, arguments);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "GIT_API_REPOS": () => (/* binding */ GIT_API_REPOS),
/* harmony export */   "GIT_API_USERS": () => (/* binding */ GIT_API_USERS),
/* harmony export */   "GIT_USER": () => (/* binding */ GIT_USER)
/* harmony export */ });
var GIT_USER = "Kamila-Vieira";
var GIT_API_USERS = "https://api.github.com/users";
var GIT_API_REPOS = "https://api.github.com/repos";

/***/ }),

/***/ "./src/scripts/services/api/index.mjs":
/*!********************************************!*\
  !*** ./src/scripts/services/api/index.mjs ***!
  \********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../mock/api.mjs */ "./src/scripts/mock/api.mjs");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var Api = {
  getUserData: function () {
    var _getUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var response;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])({
                method: "get",
                baseURL: _mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_API_USERS,
                url: "/".concat(_mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_USER)
              });
  ...
  getReposList: function () {
    var _getReposList = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var response;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])({
                method: "get",
                baseURL: _mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_API_USERS,
                url: "/".concat(_mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_USER, "/repos")
              });
    ...
    function getReposList() {
      return _getReposList.apply(this, arguments);
    }

    return getReposList;
  }(),
  getRepoData: function () {
    var _getRepoData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(repoName) {
      var response;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])({
                method: "get",
                baseURL: _mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_API_REPOS,
                url: "/".concat(_mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_USER, "/").concat(repoName)
              });
    ...
    function getRepoData(_x) {
      return _getRepoData.apply(this, arguments);
    }
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_user_index_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/user/index.mjs */ "./src/scripts/components/user/index.mjs");
/* harmony import */ var _components_repositories_index_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/repositories/index.mjs */ "./src/scripts/components/repositories/index.mjs");


_components_user_index_mjs__WEBPACK_IMPORTED_MODULE_0__.User.init();
_components_repositories_index_mjs__WEBPACK_IMPORTED_MODULE_1__.Repositories.init();
})();
