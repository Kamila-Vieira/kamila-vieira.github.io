...
var Repositories = {
  init: function init() {
    Repositories.getUserRepositories(); // Repositories.getUserRepository("kamila-vieira.github.io");
  },
  technologies: [],
  ...
  getAllTechnologies: function () {
    var _getAllTechnologies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(repoName) {
      var data;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_1__.Api.getRepoLanguages(repoName);

            case 2:
              data = _context2.sent;
              console.log(data); // Repositories.technologies
    ...
    function getAllTechnologies(_x) {
      return _getAllTechnologies.apply(this, arguments);
    }

    return getAllTechnologies;
  }(),
  updateTechnologyTags: function updateTechnologyTags(technologies) {
    ...
    $technologyTag.classList.add("sidebar-container__technologies__list__bag"); // $technologyTag.textContent = ''
  ...
  updateProjectCards: function updateProjectCards(projects) {
    ...
    projects.forEach(function (project) {
      ...
      var cardContent = Repositories.projectCardContent(project);
  ...
  projectCardContent: function projectCardContent(projectData) {
    ...
    var elementContent = "\n      <a href=\"".concat((projectData === null || projectData === void 0 ? void 0 : projectData.html_url) || "", "\" alt=\"").concat(projectData === null || projectData === void 0 ? void 0 : projectData.name, "\">\n        <strong><i class=\"fantasticon-folder\"></i>").concat(projectData === null || projectData === void 0 ? void 0 : projectData.name, "</strong>\n        <p>").concat(projectDescription, "</p>\n        <div>\n          <div>\n            <span><i class=\"fantasticon-star\"></i>").concat((projectData === null || projectData === void 0 ? void 0 : projectData.stargazers_count) || 0, "</span>\n            <span><i class=\"fantasticon-map-pin\"></i>").concat((projectData === null || projectData === void 0 ? void 0 : projectData.forks_count) || 0, "</span>\n          </div>\n          ").concat(projectData !== null && projectData !== void 0 && projectData.language ? "<span><i class=\"pin-".concat(projectData.language, "\"></i>").concat(projectData.language, "</span>") : "", "\n        </div>\n      </a>\n    ");
