...
/***/ "./src/scripts/components/posts/index.mjs":
/*!************************************************!*\
  !*** ./src/scripts/components/posts/index.mjs ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _mock_utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../mock/utils.mjs */ "./src/scripts/mock/utils.mjs");

var Posts = {
  init: function init() {
    var $postsContainer = document.querySelector(".main-container__posts__list");
    setTimeout(function () {
      $postsContainer.classList.remove("skeleton-loading-dark");
    }, _mock_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.LOADING_TIMEOUT);
  }
};

/***/ }),

/***/ "./src/scripts/components/projects/index.mjs":
/*!***************************************************!*\
  !*** ./src/scripts/components/projects/index.mjs ***!
  \***************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../services/api/index.mjs */ "./src/scripts/services/api/index.mjs");
...
var Projects = {
  ...
  getUserRepositories: function () {
    var _getUserRepositories = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var data, repositoriesProjects;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _services_api_index_mjs__WEBPACK_IMPORTED_MODULE_1__.Api.getReposList();

            case 2:
              data = _context.sent;
              repositoriesProjects = data === null || data === void 0 ? void 0 : data.map(function (repository) {
                return {
                  name: repository === null || repository === void 0 ? void 0 : repository.name,
                  html_url: repository === null || repository === void 0 ? void 0 : repository.html_url,
                  homepage: repository === null || repository === void 0 ? void 0 : repository.homepage,
                  description: repository === null || repository === void 0 ? void 0 : repository.description,
                  language: repository === null || repository === void 0 ? void 0 : repository.language,
                  stargazers_count: repository === null || repository === void 0 ? void 0 : repository.stargazers_count,
                  forks_count: repository === null || repository === void 0 ? void 0 : repository.forks_count
                };
              });
  ...
  updateProjectCards: function updateProjectCards(projects) {
    var _this = this;

    var $projectCardsList = document.querySelector(".main-container__projects__list");

    if (!projects) {
      var $projectCardEmpty = document.createElement("li");
      ...
      projects === null || projects === void 0 ? void 0 : projects.forEach(function (project) {
        ...
        var cardContent = _this.projectCardContent(project);
  ...
  projectCardContent: function projectCardContent(projectData) {
    var converter = new showdown__WEBPACK_IMPORTED_MODULE_0__.Converter();
    var projectDescription = converter.makeHtml((projectData === null || projectData === void 0 ? void 0 : projectData.description) || "");
    var elementContent = "\n      <a \n        href=\"".concat((projectData === null || projectData === void 0 ? void 0 : projectData.homepage) || (projectData === null || projectData === void 0 ? void 0 : projectData.html_url) || "", "\" \n        alt=\"").concat(projectData === null || projectData === void 0 ? void 0 : projectData.name, "\" \n        class=\"project-card__link\" \n        target=\"_blank\">\n        <strong class=\"project-card__link__name\">\n          <i class=\"fantasticon-folder\"></i>\n          ").concat(projectData === null || projectData === void 0 ? void 0 : projectData.name, "\n        </strong>\n        <div class=\"project-card__link__description\">").concat(projectDescription, "</div>\n        <div class=\"project-card__link__bottom\">\n          <div class=\"project-card__link__bottom__left\">\n            <span class=\"project-card__link__bottom__left__item\"><i class=\"fantasticon-star\"></i>").concat((projectData === null || projectData === void 0 ? void 0 : projectData.stargazers_count) || 0, "</span>\n            <span class=\"project-card__link__bottom__left__item\"><i class=\"fantasticon-git-branch\"></i>").concat((projectData === null || projectData === void 0 ? void 0 : projectData.forks_count) || 0, "</span>\n          </div>\n          ").concat(projectData !== null && projectData !== void 0 && projectData.language ? "<span class=\"project-card__link__bottom__language\"><i class=\"pin-".concat(projectData.language.toLowerCase().split(" ").join("-"), "\"></i>").concat(projectData.language, "</span>") : "", "\n        </div>\n      </a>\n    ");
    return elementContent;
  },
  handleOpenProjects: function handleOpenProjects() {
    var $seeAllButton = document.querySelector(".main-container__projects__heading__title__see-all");
    var $repositoriesContainer = document.querySelector(".main-container__projects__list__container");
...
/***/ "./src/scripts/components/technologies/index.mjs":
/*!*******************************************************!*\
  !*** ./src/scripts/components/technologies/index.mjs ***!
  \*******************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
var Technologies = {
  ...
  updateTechnologyTags: function updateTechnologyTags() {
    var $technologyTags = document.querySelector(".sidebar-container__technologies__list");
    Object.entries(this.technologiesXP).forEach(function (_ref) {
      var _ref2 = _slicedToArray(_ref, 2),
          technology = _ref2[0],
          xp = _ref2[1];

      var $technologyTag = document.createElement("li");
      var $technologyTagText = document.createElement("span");
      ...
      setTimeout(function () {
        ...
        $technologyTag.classList.add("technology-xp__".concat(xp));
      }, _mock_utils_mjs__WEBPACK_IMPORTED_MODULE_0__.LOADING_TIMEOUT);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LOADING_TIMEOUT": () => (/* binding */ LOADING_TIMEOUT)
/* harmony export */ });
...
var Api = {
          ...
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])({
                method: "get",
                baseURL: _mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_API_USERS,
                url: "/".concat(_mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_USER, "/repos?per_page=100&sort=pushed")
              });
  ...
  getRepoLanguages: function () {
    var _getRepoLanguages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(repoName) {
      var response;
          ...
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return (0,axios__WEBPACK_IMPORTED_MODULE_0__["default"])({
                method: "get",
                baseURL: _mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_API_REPOS,
                url: "/".concat(_mock_api_mjs__WEBPACK_IMPORTED_MODULE_1__.GIT_USER, "/").concat(repoName, "/languages")
              });
    ...
    function getRepoLanguages(_x2) {
      return _getRepoLanguages.apply(this, arguments);
    }
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_technologies_index_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/technologies/index.mjs */ "./src/scripts/components/technologies/index.mjs");
/* harmony import */ var _components_projects_index_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/projects/index.mjs */ "./src/scripts/components/projects/index.mjs");
/* harmony import */ var _components_posts_index_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/posts/index.mjs */ "./src/scripts/components/posts/index.mjs");



_components_projects_index_mjs__WEBPACK_IMPORTED_MODULE_1__.Projects.init();
_components_technologies_index_mjs__WEBPACK_IMPORTED_MODULE_0__.Technologies.init();
_components_posts_index_mjs__WEBPACK_IMPORTED_MODULE_2__.Posts.init();
})();
